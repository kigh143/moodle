...
$string['warningunsupporteddbstorageengine'] = 'The database storage engine being used is not supported in Moodle 2.9. You will need to convert to another database storage engine, such as InnoDB, before upgrading.';
